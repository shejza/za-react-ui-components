...
export default {
  title: "ListingCompact",
  component: ListingCompact,
  argTypes: {
...
Default.args = {
  ...
  description: "Quia hic deserunt. Aspernatur vitae necessitatibus. Rerum et id. Quia hic deserunt. Aspernatur vitae necessitatibus. Rerum et id. Quia hic deserunt. Aspernatur vitae necessitatibus. Rerum et id. Quia hic deserunt. Aspernatur vitae necessitatibus. Rerum et id. Quia hic deserunt. Aspernatur vitae necessitatibus. Rerum et id. Quia hic deserunt. Aspernatur vitae necessitatibus. Rerum et id. Quia hic deserunt. Aspernatur vitae necessitatibus. Rerum et id. Quia hic deserunt. Aspernatur vitae necessitatibus. Rerum et id.",
  activities: ["Create"],
  ...
  connectSocialMedias,
  readMore,
  image_url: "https://thrivecoin-assets.s3.amazonaws.com/images/snapshot_app.png"
};
